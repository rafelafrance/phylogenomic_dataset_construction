"""
trim trinity length and path information from transcript fasta names of good
contigs
"""
...
def short_trinity_names(transcripts, DIR):
    ...
    transcripts_short_name_file = base_name_transcripts[
        0] + ".Trinity.short_name.fa"
    ...
    # trim trinity length and path information from transcript fasta names of
    # good contigs
    searchstr = r'(>\w+)(\slen.*)'
    replacestr = r'\1'
